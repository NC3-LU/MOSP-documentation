...
This document is a user guide to link:https://github.com/CASES-LU/MOSP[MOSP],
a platform to create, edit and share JSON objects.

The main goal is to gather security related JSON objects, in the first place
aimed to be used with MONARC. 


== Objects involved in MISP
...
Validation errors are displayed in the grey box at the right of the
interface.
