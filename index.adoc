...
Each objects you create within MOSP will be conforms to a selected schema.
...
When creating a new object with MOSP you have first to choose a JSON schema and an owning organization. A user account can be bind to one or
...
The forms above is generated form the validating JSON schema.
Validation errors are displayed in the grey box at the right of the interface.
